...
<html>
  <head>
    <meta charset="UTF-8">
    <title>GreenSurvey-Register</title>
    ...
    <style>
      ...
      body {
        background: url(/images/reg-bg.jpg) 0% 0% / cover no-repeat;
        position: static;
        font-size: 12px;
      }
        ...
        <form class="layui-form login-bottom">
          <div class="center">
            <div class="item">
              ...
              <input type="text" id="username" name="username" lay-verify="required" placeholder="Account"
                     maxlength="24"/>
            </div>
            
            <div class="item">
              <span class="icon icon-3"></span>
              <input type="password" id="password" name="password" lay-verify="required" placeholder="Paasword" maxlength="20">
          ...
          <div class="tip">
            ...
            <a href="/api/sysUser/login" class="forget-password">Login</a>
          </div>
          <div class="layui-form-item" style="text-align:center; width:100%;height:100%;margin:0px;">
            <button class="login-btn" id="registerBtn" type="button">Register</button>
          </div>
        </form>
      </div>
    </div>
